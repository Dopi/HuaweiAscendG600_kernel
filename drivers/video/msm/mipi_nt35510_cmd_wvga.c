...
static int nt35510_config_auto_cabc(struct msmfb_cabc_config cabc_cfg,struct msm_fb_data_type *mfd)
{
	...
	{
		case CABC_MODE_UI:
			nt35510_auto_cabc_set_table[5].reg=0x00001;
			break;
		case CABC_MODE_MOVING:
		case CABC_MODE_STILL:
			nt35510_auto_cabc_set_table[5].reg=0x00003;
			break;
		default:
	...
	if(likely(0 == ret))
	{
		process_mipi_table(mfd,&nt35510_tx_buf,(struct sequence*)&nt35510_auto_cabc_set_table,
			 ARRAY_SIZE(nt35510_auto_cabc_set_table), MIPI_NT35510_BOE_WVGA);
	}
...
static int __init mipi_cmd_nt35510_wvga_init(void)
{
	...
	if (MIPI_NT35510_BOE_WVGA != lcd_panel_wvga )
	{
		return 0;
	}
	printk("enter mipi_cmd_nt35510_wvga_init \n");
